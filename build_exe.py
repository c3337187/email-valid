...
4. Создаёт папку `complite`, кладёт туда EXE, пустой файл `LIST-EMAIL.txt`
   и краткую инструкцию по запуску.
"""
...
def stage_complite_folder(exe_path: Path) -> Path:
    ...
    readme_text = textwrap.dedent(
        ...
        3) После проверки появятся файлы:
           ...
           - {DEFAULT_INVALID_NAME} — невалидные адреса (по одному в строке).
